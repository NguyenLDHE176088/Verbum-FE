...
export function JobsScreen() {
  ...
  React.useEffect(() => {
    fetch("http://localhost:9999/jobs")
      ...
      .then((fetchedData) => {
        // Merge each object in fetched data with mock data
        const combinedData = fetchedData.map((item) => ({...MOCK_PROJECT, ...item}));
  ...
  return (
    <div className="w-full px-2 border-solid border-2 rounded-lg">
